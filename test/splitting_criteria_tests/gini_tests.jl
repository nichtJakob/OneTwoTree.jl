...
@testset "Gini Impurity" begin
    ...
    @testset "Test with Integer Labels" begin
        ...
        gini1 = OneTwoTree.gini_impurity(features1, labels1, node_data1, less_than_or_equal, 2.0, 1)
    ...
    @testset "Test with String Labels" begin
        ...
        node_data2 = [1, 2, 3, 4]
        gini2 = OneTwoTree.gini_impurity(features2, labels2, node_data2, equal, "high", 1)
    ...
    @testset "Test with Multi-Class String Labels" begin
        ...
        gini3 = OneTwoTree.gini_impurity(features3, labels3, node_data3, equal, "medium", 1)
    ...
    @testset "Test 5: All labels are the same" begin
        ...
        gini5 = OneTwoTree.gini_impurity(features5, labels5, node_data5, less_than_or_equal, 3.0, 1)
    ...
    @testset "Test 6: Perfect split" begin
        ...
        gini6 = OneTwoTree.gini_impurity(features6, labels6, node_data6, less_than_or_equal, 3.0, 1)
    ...
    @testset "Test 7: Uneven split with imbalance" begin
        ...
        gini7 = OneTwoTree.gini_impurity(features7, labels7, node_data7, less_than_or_equal, 35.0, 1)
    ...
    @testset "Test 8: Subset of node_data" begin
        ...
        gini8 = OneTwoTree.gini_impurity(features8, labels8, node_data8, equal, "high", 1)
    ...
    @testset "Test 9: No matching decision function" begin
        ...
        gini9 = OneTwoTree.gini_impurity(features9, labels9, node_data9, equal, "high", 1)
        @test gini9 == 0.5
    end
end