...
splitting_point = 120
println("It is $(splitting_point > 1 && splitting_point < 150) that you have chosen a qualifying splitting point $(splitting_point)", "\n")
...
println("The forest has been grown")
